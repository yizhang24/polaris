...
class Detector:
    ...
    def __init__(self) -> None:
        # self._detector_params.useAruco3Detection = True
        self._detector_params.cornerRefinementMethod = aruco.CORNER_REFINE_SUBPIX
        # print(self._detector_params.cornerRefinementMethod)
    ...
    def detectAruco(self, image: Mat) -> List[FiducialObservation2d]:
        ...
        if len(corners) == 0:
            return []
        return [FiducialObservation2d(id[0], corner) for id, corner in zip(ids, corners)]
